...
const MONTH_DEITIES: EgyptianMonthDeity[] = [
  ...
  { monthName: 'Choiak (Ka-her-ka)', deity: 'Sokar-Osiris', deityHieroglyphic: '𓁜𓃰𓉹', description: 'Originalmente Ka-her-ka ("Ka sobre Ka"). Mes de los Misterios de Osiris y del festival de Sokar. La Clepsidra de Karnak lo asocia a Sekhmet.', domain: 'Muerte y Resurrección' },
  ...
  { monthName: 'Mechir (Rokeh-wer)', deity: 'Ptah', deityHieroglyphic: '𓁰', description: 'Llamado "La Gran Quema" (Rokeh-wer). Mes de rituales de fuego menfitas asociados al dios creador Ptah.', domain: 'Fuego y Purificación' },
  { monthName: 'Phamenoth (Rokeh-nedjes)', deity: 'Ptah', deityHieroglyphic: '𓁰', description: 'Llamado "La Pequeña Quema" (Rokeh-nedjes). Continúa los rituales de fuego del mes anterior bajo el patronazgo de Ptah.', domain: 'Fuego Protector' },
